...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Chhatresh Sehgal}{ %\urlstyle{same}\href{http://example.com}{example.com}| \href{http://example2.co}{example2.co}\\
\href{mailto:john.doe@example.com}{chhatseh@gmail.com} | \href{tel:11111111111}{+666 3974 2505}
}
...
\section{Experience}
\runsubsection{Coforge}
\descript{| Advanced Development Intern }
\location{May 2024 - July 2024 | Bangna, Bangkok-10260, Thailand}
...
\section{Projects}
\runsubsection{Comparative Analysis of 1D Bin Packing Algorithms}
\descript{| Algorithm Researcher}
\location{2023 | GitHub}
\begin{tightemize}
...
\runsubsection{Retro Brick Breaker Game}
...
\runsubsection{Flower Image Segmentation}
...
\runsubsection{Dynamic Regularization in RL}
\descript{| Machine Learning Researcher}
\location{2024 | GitHub}
\begin{tightemize}
...
\descript{BSc (Hons) Computer Science with Artificial Intelligence}
\location{Graduation: July 2025}
